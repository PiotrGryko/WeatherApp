...
public class CityDetailFragment extends BaseFragment implements CityDetailContract.View {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState); Bundle bundle = getArguments();
        String cityData = bundle.getString("city");
        final ModelCity city = ModelCity.fromJson(cityData); fragmentDetailBinding.setCity(city);
    ...
    public void forecastLoaded() {
        ...
        mySnackbar.setAction("OK", null); mySnackbar.show();
